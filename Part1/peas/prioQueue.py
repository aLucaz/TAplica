...
class Frontier: 
    ...
    "Agrego un nodo en la posicion correcta de acuerdo a su funcion de evaluacion, menor distancia a mayor distancia"
    def add(self,node):         
        fn = self.fn(node)
    ...
    "Para saber si algun nodo esta en la frontera"
